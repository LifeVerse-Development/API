...
export const createBetaKey: RequestHandler = withCache(
...
export const getAllBetaKeys: RequestHandler = withCache(
...
export const getBetaKeyById: RequestHandler = withCache(
    asyncHandler(async (req: Request, res: Response): Promise<void> => {
        try {
...
export const updateBetaKey: RequestHandler = withCache(
    asyncHandler(async (req: Request, res: Response): Promise<void> => {
        try {
            const updatedData = {
                ...req.body,
...
export const deleteBetaKey: RequestHandler = withCache(
    asyncHandler(async (req: Request, res: Response): Promise<void> => {
        try {
...
export const toggleBetaSystem: RequestHandler = withCache(
    asyncHandler(async (_req: Request, res: Response): Promise<void> => {
        try {
            const beta = await Beta.findOne();
            if (!beta) {
