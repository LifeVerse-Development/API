...
export const createMaintenance: RequestHandler = async (req: Request, res: Response): Promise<void> => {
    try {
...
export const getAllMaintenance: RequestHandler = async (_req: Request, res: Response): Promise<void> => {
    try {
...
export const getMaintenanceById: RequestHandler = async (req: Request, res: Response): Promise<void> => {
    try {
...
export const updateMaintenance: RequestHandler = async (req: Request, res: Response): Promise<void> => {
    try {
        const updatedData = {
            ...req.body,
        };

        const maintenance = await Maintenance.findByIdAndUpdate(req.params.maintenanceId, updatedData, { new: true, runValidators: true });
        if (!maintenance) {
...
export const deleteMaintenance: RequestHandler = async (req: Request, res: Response): Promise<void> => {
    try {
