 ...
 * @access  Public
 */
export const createUser = withCache(
    asyncHandler(async (req: Request, res: Response) => {
        ...
        // Invalidate user list cache after creating a new user
 ...
 * @access  Private
 */
export const updateUser = withCache(
    asyncHandler(async (req: Request, res: Response) => {
        const { userId } = req.params;
        ...
        await invalidateCache([`cache:*/api/users/${userId}*`, `cache:*/api/users?*`, `users:${userId}`, `users:all:*`]);
 ...
 * @access  Private
 */
export const deleteUser = withCache(
    asyncHandler(async (req: Request, res: Response) => {
        const { userId } = req.params;
 ...
 * @access  Private
 */
export const followUser = withCache(
    asyncHandler(async (req: Request, res: Response) => {
        const { userId } = req.params;
 ...
 * @access  Private
 */
export const unfollowUser = withCache(
    asyncHandler(async (req: Request, res: Response) => {
        const { userId } = req.params;
        ...
        await invalidateCache([
            `cache:*/api/users/${userId}*`,
            `cache:*/api/users/${unfollowUserId}*`,
            `users:${userId}*`,
            `users:${unfollowUserId}*`,
        ]);
 ...
 * @access  Private
 */
export const getFollowStats = withCache(
    asyncHandler(async (req: Request, res: Response) => {
        const { userId } = req.params;
 ...
 * @access  Private
 */
export const createPost = withCache(
    asyncHandler(async (req: Request, res: Response) => {
        const { userId } = req.params;
 ...
 * @access  Private
 */
export const updatePost = withCache(
    asyncHandler(async (req: Request, res: Response) => {
        const { userId, postId } = req.params;
        const updateData = { ...req.body };
        ...
        await invalidateCache([
            `cache:*/api/users/${userId}*`,
            `cache:*/api/users/${userId}/posts*`,
            `cache:*/api/users/${userId}/posts/${postId}*`,
            `users:${userId}*`,
            `users:${userId}:posts*`,
        ]);
 ...
 * @access  Private
 */
export const deletePost = withCache(
    asyncHandler(async (req: Request, res: Response) => {
        const { userId, postId } = req.params;
 ...
 * @access  Private
 */
export const updatePassword = withCache(
    asyncHandler(async (req: Request, res: Response) => {
 ...
 * @access  Private
 */
export const setupTwoFactorAuth = withCache(
    asyncHandler(async (req: Request, res: Response) => {
 ...
 * @access  Private
 */
export const verifyTwoFactorAuth = withCache(
    asyncHandler(async (req: Request, res: Response) => {
 ...
 * @access  Private
 */
export const disableTwoFactorAuth = withCache(
    asyncHandler(async (req: Request, res: Response) => {
        const { userId } = req.params;
 ...
 * @access  Private
 */
export const generateRecoveryCodes = withCache(
    asyncHandler(async (req: Request, res: Response) => {
 ...
 * @access  Private
 */
export const verifyEmail = withCache(
    asyncHandler(async (req: Request, res: Response) => {
        createRateLimit({ windowMs: 15 * 60 * 1000, max: 5 })(req, res, () => {});
        ...
        await invalidateCache([`cache:*/api/users/${userId}*`, `users:${userId}`]);
 ...
 * @access  Private
 */
export const verifyDiscord = withCache(
    asyncHandler(async (req: Request, res: Response) => {
        createRateLimit({ windowMs: 15 * 60 * 1000, max: 5 })(req, res, () => {});
 ...
 * @access  Private
 */
export const verifySMS = withCache(
    asyncHandler(async (req: Request, res: Response) => {
        createRateLimit({ windowMs: 15 * 60 * 1000, max: 5 })(req, res, () => {});
 ...
 * @access  Private
 */
export const updatePrivacySettings = withCache(
    asyncHandler(async (req: Request, res: Response) => {
        const { userId } = req.params;
 ...
 * @access  Private
 */
export const updateNotificationSettings = withCache(
    asyncHandler(async (req: Request, res: Response) => {
        const { userId } = req.params;
 ...
 * @access  Private
 */
export const updatePreferences = withCache(
    asyncHandler(async (req: Request, res: Response) => {
        const { userId } = req.params;
 ...
 * @access  Private
 */
export const logoutAllSessions = withCache(
    asyncHandler(async (req: Request, res: Response) => {
        createRateLimit({ windowMs: 60 * 60 * 1000, max: 3 })(req, res, () => {});
...
export const uploadProfileImages = withCache(
