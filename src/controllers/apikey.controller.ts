...
export const createApiKey: RequestHandler = withCache(
...
export const getAllApiKeys: RequestHandler = withCache(
...
export const getApiKeyById: RequestHandler = withCache(
    asyncHandler(async (req: Request, res: Response): Promise<void> => {
...
export const updateApiKey: RequestHandler = withCache(
    asyncHandler(async (req: Request, res: Response): Promise<void> => {
        const { apiKeyId } = req.params;
...
export const deleteApiKey: RequestHandler = withCache(
    asyncHandler(async (req: Request, res: Response): Promise<void> => {
        const { apiKeyId } = req.params;
