...
export const createNewsletter: RequestHandler = async (req: Request, res: Response): Promise<void> => {
    try {
...
export const sendNewsletter: RequestHandler = async (req: Request, res: Response): Promise<void> => {
    try {
        const { id } = req.params;
...
export const getNewsletters: RequestHandler = async (_req: Request, res: Response): Promise<void> => {
    try {
