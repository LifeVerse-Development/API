...
export const createBlogPost: RequestHandler = withCache(
...
export const getAllBlogPosts: RequestHandler = withCache(
...
export const getBlogPostById: RequestHandler = withCache(
    asyncHandler(async (req: Request, res: Response): Promise<void> => {
...
export const updateBlogPost: RequestHandler = withCache(
    asyncHandler(async (req: Request, res: Response): Promise<void> => {
        const { blogId } = req.params;
        const { title, description, content, tags, author, image } = req.body;
...
export const deleteBlogPost: RequestHandler = withCache(
    asyncHandler(async (req: Request, res: Response): Promise<void> => {
        const { blogId } = req.params;
