...
export const sendEmailController: RequestHandler = withCache(
...
export const getEmailsController: RequestHandler = withCache(
...
export const getEmailByIdController: RequestHandler = withCache(
    asyncHandler(async (req: Request, res: Response): Promise<void> => {
...
export const deleteAllEmailsController: RequestHandler = withCache(
    asyncHandler(async (_req: Request, res: Response): Promise<void> => {
        try {
...
export const deleteEmailByIdController: RequestHandler = withCache(
    asyncHandler(async (req: Request, res: Response): Promise<void> => {
        const { emailId } = req.params;
...
export const fetchAndStoreEmailsController: RequestHandler = withCache(
    asyncHandler(async (_req: Request, res: Response): Promise<void> => {
        try {
