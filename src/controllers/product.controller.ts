...
export const getAllProducts: RequestHandler = withCache(
...
export const getProductById: RequestHandler = withCache(
    asyncHandler(async (req: Request, res: Response): Promise<void> => {
        try {
...
export const createProduct: RequestHandler = withCache(
    asyncHandler(async (req: Request, res: Response): Promise<void> => {
        try {
...
export const updateProduct: RequestHandler = withCache(
    asyncHandler(async (req: Request, res: Response): Promise<void> => {
        try {
            const { id: productId } = req.params;
            const { name, price, category, description, stock } = req.body;
...
export const deleteProduct: RequestHandler = withCache(
    asyncHandler(async (req: Request, res: Response): Promise<void> => {
        try {
            const { id: productId } = req.params;
...
export const getRelatedProducts: RequestHandler = withCache(
    asyncHandler(async (req: Request, res: Response): Promise<void> => {
        try {
            const { id: productId } = req.params;
...
export const getReviews: RequestHandler = withCache(
    asyncHandler(async (req: Request, res: Response): Promise<void> => {
        try {
            const { id: productId } = req.params;
...
export const addReview: RequestHandler = withCache(
    asyncHandler(async (req: Request, res: Response): Promise<void> => {
        try {
            const { id: productId } = req.params;
